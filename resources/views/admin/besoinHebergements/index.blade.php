...
@section('content')
@can('besoin_hebergement_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.besoin-hebergements.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.besoinHebergement.title_singular') }}
            </a>
            <button class="btn btn-warning" data-toggle="modal" data-target="#csvImportModal">
                {{ trans('global.app_csvImport') }}
            </button>
            @include('csvImport.modal', ['model' => 'BesoinHebergement', 'route' => 'admin.besoin-hebergements.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.besoinHebergement.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-BesoinHebergement">
            <thead>
                <tr>
                    <th width="10">
...
@can('besoin_hebergement_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.besoin-hebergements.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.besoin-hebergements.index') }}",
    columns: [
...
{ data: 'conveniences', name: 'conveniences' },
{ data: 'servicesinclus', name: 'servicesinclus' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-BesoinHebergement').DataTable(dtOverrideGlobals);
