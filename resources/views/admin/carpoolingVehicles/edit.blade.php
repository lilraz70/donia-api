...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.carpoolingVehicle.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.carpooling-vehicles.update", [$carpoolingVehicle->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="finition">{{ trans('cruds.carpoolingVehicle.fields.finition') }}</label>
                <input class="form-control {{ $errors->has('finition') ? 'is-invalid' : '' }}" type="text" name="finition" id="finition" value="{{ old('finition', $carpoolingVehicle->finition) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nb_place') ? 'is-invalid' : '' }}" type="number" name="nb_place" id="nb_place" value="{{ old('nb_place', $carpoolingVehicle->nb_place) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('annee_fabrication') ? 'is-invalid' : '' }}" type="text" name="annee_fabrication" id="annee_fabrication" value="{{ old('annee_fabrication', $carpoolingVehicle->annee_fabrication) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('conso_au_100_km') ? 'is-invalid' : '' }}" type="text" name="conso_au_100_km" id="conso_au_100_km" value="{{ old('conso_au_100_km', $carpoolingVehicle->conso_au_100_km) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nb_chevaux') ? 'is-invalid' : '' }}" type="number" name="nb_chevaux" id="nb_chevaux" value="{{ old('nb_chevaux', $carpoolingVehicle->nb_chevaux) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nb_cylindre') ? 'is-invalid' : '' }}" type="number" name="nb_cylindre" id="nb_cylindre" value="{{ old('nb_cylindre', $carpoolingVehicle->nb_cylindre) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('accessoires') ? 'is-invalid' : '' }}" type="text" name="accessoires" id="accessoires" value="{{ old('accessoires', $carpoolingVehicle->accessoires) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kilometrage') ? 'is-invalid' : '' }}" type="number" name="kilometrage" id="kilometrage" value="{{ old('kilometrage', $carpoolingVehicle->kilometrage) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('options') ? 'is-invalid' : '' }}" type="text" name="options" id="options" value="{{ old('options', $carpoolingVehicle->options) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pannes_signalees') ? 'is-invalid' : '' }}" type="text" name="pannes_signalees" id="pannes_signalees" value="{{ old('pannes_signalees', $carpoolingVehicle->pannes_signalees) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('immatriculation') ? 'is-invalid' : '' }}" type="text" name="immatriculation" id="immatriculation" value="{{ old('immatriculation', $carpoolingVehicle->immatriculation) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('brand') ? 'is-invalid' : '' }}" name="brand_id" id="brand_id" required>
                    @foreach($brands as $id => $entry)
                        <option value="{{ $id }}" {{ (old('brand_id') ? old('brand_id') : $carpoolingVehicle->brand->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('brand'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('modelofvehicle') ? 'is-invalid' : '' }}" name="modelofvehicle_id" id="modelofvehicle_id" required>
                    @foreach($modelofvehicles as $id => $entry)
                        <option value="{{ $id }}" {{ (old('modelofvehicle_id') ? old('modelofvehicle_id') : $carpoolingVehicle->modelofvehicle->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('colortype') ? 'is-invalid' : '' }}" name="colortype_id" id="colortype_id" required>
                    @foreach($colortypes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('colortype_id') ? old('colortype_id') : $carpoolingVehicle->colortype->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('energytype') ? 'is-invalid' : '' }}" name="energytype_id" id="energytype_id" required>
                    @foreach($energytypes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('energytype_id') ? old('energytype_id') : $carpoolingVehicle->energytype->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('gearbox') ? 'is-invalid' : '' }}" name="gearbox_id" id="gearbox_id" required>
                    @foreach($gearboxes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('gearbox_id') ? old('gearbox_id') : $carpoolingVehicle->gearbox->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('vehicletype') ? 'is-invalid' : '' }}" name="vehicletype_id" id="vehicletype_id" required>
                    @foreach($vehicletypes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('vehicletype_id') ? old('vehicletype_id') : $carpoolingVehicle->vehicletype->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('motricitytype') ? 'is-invalid' : '' }}" name="motricitytype_id" id="motricitytype_id" required>
                    @foreach($motricitytypes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('motricitytype_id') ? old('motricitytype_id') : $carpoolingVehicle->motricitytype->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('typeofwheel') ? 'is-invalid' : '' }}" name="typeofwheel_id" id="typeofwheel_id" required>
                    @foreach($typeofwheels as $id => $entry)
                        <option value="{{ $id }}" {{ (old('typeofwheel_id') ? old('typeofwheel_id') : $carpoolingVehicle->typeofwheel->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('rimtype') ? 'is-invalid' : '' }}" name="rimtype_id" id="rimtype_id" required>
                    @foreach($rimtypes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('rimtype_id') ? old('rimtype_id') : $carpoolingVehicle->rimtype->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('listofcountry') ? 'is-invalid' : '' }}" name="listofcountry_id" id="listofcountry_id" required>
                    @foreach($listofcountries as $id => $entry)
                        <option value="{{ $id }}" {{ (old('listofcountry_id') ? old('listofcountry_id') : $carpoolingVehicle->listofcountry->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id" id="user_id" required>
                    @foreach($users as $id => $entry)
                        <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $carpoolingVehicle->user->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('user'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('liststatut') ? 'is-invalid' : '' }}" name="liststatut_id" id="liststatut_id" required>
                    @foreach($liststatuts as $id => $entry)
                        <option value="{{ $id }}" {{ (old('liststatut_id') ? old('liststatut_id') : $carpoolingVehicle->liststatut->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('typeofutility') ? 'is-invalid' : '' }}" name="typeofutility_id" id="typeofutility_id" required>
                    @foreach($typeofutilities as $id => $entry)
                        <option value="{{ $id }}" {{ (old('typeofutility_id') ? old('typeofutility_id') : $carpoolingVehicle->typeofutility->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('libelle') ? 'is-invalid' : '' }}" type="text" name="libelle" id="libelle" value="{{ old('libelle', $carpoolingVehicle->libelle) }}" required>
