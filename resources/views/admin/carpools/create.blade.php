...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.carpool.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.carpools.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user_client') ? 'is-invalid' : '' }}" name="user_client_id" id="user_client_id" required>
                    @foreach($user_clients as $id => $entry)
                        <option value="{{ $id }}" {{ old('user_client_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user_fournisseur') ? 'is-invalid' : '' }}" name="user_fournisseur_id" id="user_fournisseur_id" required>
                    @foreach($user_fournisseurs as $id => $entry)
                        <option value="{{ $id }}" {{ old('user_fournisseur_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('paiement') ? 'is-invalid' : '' }}" type="text" name="paiement" id="paiement" value="{{ old('paiement', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('preuve_paiement') ? 'is-invalid' : '' }}" type="text" name="preuve_paiement" id="preuve_paiement" value="{{ old('preuve_paiement', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('paymentmode') ? 'is-invalid' : '' }}" name="paymentmode_id" id="paymentmode_id">
                    @foreach($paymentmodes as $id => $entry)
                        <option value="{{ $id }}" {{ old('paymentmode_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mention_arrive') ? 'is-invalid' : '' }}" type="text" name="mention_arrive" id="mention_arrive" value="{{ old('mention_arrive', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mention_arv_heure') ? 'is-invalid' : '' }}" type="text" name="mention_arv_heure" id="mention_arv_heure" value="{{ old('mention_arv_heure', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('carpoolingvehicle') ? 'is-invalid' : '' }}" name="carpoolingvehicle_id" id="carpoolingvehicle_id" required>
                    @foreach($carpoolingvehicles as $id => $entry)
                        <option value="{{ $id }}" {{ old('carpoolingvehicle_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
