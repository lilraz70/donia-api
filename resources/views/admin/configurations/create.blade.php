    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.configurations.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cle') ? 'is-invalid' : '' }}" type="text" name="cle" id="cle" value="{{ old('cle', '') }}" required>
                @if($errors->has('cle'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('valeur') ? 'is-invalid' : '' }}" type="text" name="valeur" id="valeur" value="{{ old('valeur', '') }}">
