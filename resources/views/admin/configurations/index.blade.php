...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Configuration">
            <thead>
                <tr>
                    <th width="10">
                    ...
                    <th>
                        {{ trans('cruds.configuration.fields.cle') }}
                    </th>
                    <th>
                        {{ trans('cruds.configuration.fields.valeur') }}
                    </th>
                    <th>
                        &nbsp;
                    </th>
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.configurations.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Configuration').DataTable(dtOverrideGlobals);
