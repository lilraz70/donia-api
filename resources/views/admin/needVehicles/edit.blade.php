...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.needVehicle.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.need-vehicles.update", [$needVehicle->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="finition">{{ trans('cruds.needVehicle.fields.finition') }}</label>
                <input class="form-control {{ $errors->has('finition') ? 'is-invalid' : '' }}" type="text" name="finition" id="finition" value="{{ old('finition', $needVehicle->finition) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nb_place') ? 'is-invalid' : '' }}" type="number" name="nb_place" id="nb_place" value="{{ old('nb_place', $needVehicle->nb_place) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('annee_fabrication') ? 'is-invalid' : '' }}" type="text" name="annee_fabrication" id="annee_fabrication" value="{{ old('annee_fabrication', $needVehicle->annee_fabrication) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('conso_au_100_km') ? 'is-invalid' : '' }}" type="text" name="conso_au_100_km" id="conso_au_100_km" value="{{ old('conso_au_100_km', $needVehicle->conso_au_100_km) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nb_chevaux') ? 'is-invalid' : '' }}" type="number" name="nb_chevaux" id="nb_chevaux" value="{{ old('nb_chevaux', $needVehicle->nb_chevaux) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nb_cylindre') ? 'is-invalid' : '' }}" type="number" name="nb_cylindre" id="nb_cylindre" value="{{ old('nb_cylindre', $needVehicle->nb_cylindre) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('accessoires') ? 'is-invalid' : '' }}" type="text" name="accessoires" id="accessoires" value="{{ old('accessoires', $needVehicle->accessoires) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kilometrage') ? 'is-invalid' : '' }}" type="number" name="kilometrage" id="kilometrage" value="{{ old('kilometrage', $needVehicle->kilometrage) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('options') ? 'is-invalid' : '' }}" type="text" name="options" id="options" value="{{ old('options', $needVehicle->options) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pannes_signalees') ? 'is-invalid' : '' }}" type="text" name="pannes_signalees" id="pannes_signalees" value="{{ old('pannes_signalees', $needVehicle->pannes_signalees) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('immatriculation') ? 'is-invalid' : '' }}" type="text" name="immatriculation" id="immatriculation" value="{{ old('immatriculation', $needVehicle->immatriculation) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('brand') ? 'is-invalid' : '' }}" name="brand_id" id="brand_id" required>
                    @foreach($brands as $id => $entry)
                        <option value="{{ $id }}" {{ (old('brand_id') ? old('brand_id') : $needVehicle->brand->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('brand'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('modelofvehicle') ? 'is-invalid' : '' }}" name="modelofvehicle_id" id="modelofvehicle_id" required>
                    @foreach($modelofvehicles as $id => $entry)
                        <option value="{{ $id }}" {{ (old('modelofvehicle_id') ? old('modelofvehicle_id') : $needVehicle->modelofvehicle->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('colortype') ? 'is-invalid' : '' }}" name="colortype_id" id="colortype_id" required>
                    @foreach($colortypes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('colortype_id') ? old('colortype_id') : $needVehicle->colortype->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('energytype') ? 'is-invalid' : '' }}" name="energytype_id" id="energytype_id" required>
                    @foreach($energytypes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('energytype_id') ? old('energytype_id') : $needVehicle->energytype->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('gearbox') ? 'is-invalid' : '' }}" name="gearbox_id" id="gearbox_id" required>
                    @foreach($gearboxes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('gearbox_id') ? old('gearbox_id') : $needVehicle->gearbox->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('vehicletype') ? 'is-invalid' : '' }}" name="vehicletype_id" id="vehicletype_id" required>
                    @foreach($vehicletypes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('vehicletype_id') ? old('vehicletype_id') : $needVehicle->vehicletype->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('typeofutility') ? 'is-invalid' : '' }}" name="typeofutility_id" id="typeofutility_id" required>
                    @foreach($typeofutilities as $id => $entry)
                        <option value="{{ $id }}" {{ (old('typeofutility_id') ? old('typeofutility_id') : $needVehicle->typeofutility->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('motricitytype') ? 'is-invalid' : '' }}" name="motricitytype_id" id="motricitytype_id" required>
                    @foreach($motricitytypes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('motricitytype_id') ? old('motricitytype_id') : $needVehicle->motricitytype->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('typeofwheel') ? 'is-invalid' : '' }}" name="typeofwheel_id" id="typeofwheel_id" required>
                    @foreach($typeofwheels as $id => $entry)
                        <option value="{{ $id }}" {{ (old('typeofwheel_id') ? old('typeofwheel_id') : $needVehicle->typeofwheel->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('rimtype') ? 'is-invalid' : '' }}" name="rimtype_id" id="rimtype_id" required>
                    @foreach($rimtypes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('rimtype_id') ? old('rimtype_id') : $needVehicle->rimtype->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('listofcountry') ? 'is-invalid' : '' }}" name="listofcountry_id" id="listofcountry_id" required>
                    @foreach($listofcountries as $id => $entry)
                        <option value="{{ $id }}" {{ (old('listofcountry_id') ? old('listofcountry_id') : $needVehicle->listofcountry->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id" id="user_id" required>
                    @foreach($users as $id => $entry)
                        <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $needVehicle->user->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('user'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('liststatut') ? 'is-invalid' : '' }}" name="liststatut_id" id="liststatut_id" required>
                    @foreach($liststatuts as $id => $entry)
                        <option value="{{ $id }}" {{ (old('liststatut_id') ? old('liststatut_id') : $needVehicle->liststatut->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('typeoffer') ? 'is-invalid' : '' }}" name="typeoffer_id" id="typeoffer_id" required>
                    @foreach($typeoffers as $id => $entry)
                        <option value="{{ $id }}" {{ (old('typeoffer_id') ? old('typeoffer_id') : $needVehicle->typeoffer->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('budget_max_achat') ? 'is-invalid' : '' }}" type="number" name="budget_max_achat" id="budget_max_achat" value="{{ old('budget_max_achat', $needVehicle->budget_max_achat) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('budget_max_location') ? 'is-invalid' : '' }}" type="number" name="budget_max_location" id="budget_max_location" value="{{ old('budget_max_location', $needVehicle->budget_max_location) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $needVehicle->description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('libelle') ? 'is-invalid' : '' }}" type="text" name="libelle" id="libelle" value="{{ old('libelle', $needVehicle->libelle) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('emergencylevel') ? 'is-invalid' : '' }}" name="emergencylevel_id" id="emergencylevel_id" required>
                    @foreach($emergencylevels as $id => $entry)
                        <option value="{{ $id }}" {{ (old('emergencylevel_id') ? old('emergencylevel_id') : $needVehicle->emergencylevel->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_limite_demande') ? 'is-invalid' : '' }}" type="text" name="date_limite_demande" id="date_limite_demande" value="{{ old('date_limite_demande', $needVehicle->date_limite_demande) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('satisfait') ? 'is-invalid' : '' }}" type="text" name="satisfait" id="satisfait" value="{{ old('satisfait', $needVehicle->satisfait) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_satisfait') ? 'is-invalid' : '' }}" type="text" name="date_satisfait" id="date_satisfait" value="{{ old('date_satisfait', $needVehicle->date_satisfait) }}">
