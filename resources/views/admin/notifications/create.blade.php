    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.notifications.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contenu') ? 'is-invalid' : '' }}" type="text" name="contenu" id="contenu" value="{{ old('contenu', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sujet') ? 'is-invalid' : '' }}" type="text" name="sujet" id="sujet" value="{{ old('sujet', '') }}" required>
                @if($errors->has('sujet'))
