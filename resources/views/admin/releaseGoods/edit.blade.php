...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.releaseGood.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.release-goods.update", [$releaseGood->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="date_sorti_prevu">{{ trans('cruds.releaseGood.fields.date_sorti_prevu') }}</label>
                <input class="form-control date {{ $errors->has('date_sorti_prevu') ? 'is-invalid' : '' }}" type="text" name="date_sorti_prevu" id="date_sorti_prevu" value="{{ old('date_sorti_prevu', $releaseGood->date_sorti_prevu) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('conditions_bailleur') ? 'is-invalid' : '' }}" name="conditions_bailleur" id="conditions_bailleur" required>{{ old('conditions_bailleur', $releaseGood->conditions_bailleur) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('commentaires') ? 'is-invalid' : '' }}" name="commentaires" id="commentaires">{{ old('commentaires', $releaseGood->commentaires) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nb_chambre') ? 'is-invalid' : '' }}" type="number" name="nb_chambre" id="nb_chambre" value="{{ old('nb_chambre', $releaseGood->nb_chambre) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('localisation') ? 'is-invalid' : '' }}" name="localisation" id="localisation" required>{{ old('localisation', $releaseGood->localisation) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('geolocalisation') ? 'is-invalid' : '' }}" type="text" name="geolocalisation" id="geolocalisation" value="{{ old('geolocalisation', $releaseGood->geolocalisation) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_limite') ? 'is-invalid' : '' }}" type="text" name="date_limite" id="date_limite" value="{{ old('date_limite', $releaseGood->date_limite) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_bailleur') ? 'is-invalid' : '' }}" type="text" name="contact_bailleur" id="contact_bailleur" value="{{ old('contact_bailleur', $releaseGood->contact_bailleur) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('accord_bailleur') ? 'is-invalid' : '' }}" type="text" name="accord_bailleur" id="accord_bailleur" value="{{ old('accord_bailleur', $releaseGood->accord_bailleur) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('propertytype') ? 'is-invalid' : '' }}" name="propertytype_id" id="propertytype_id" required>
                    @foreach($propertytypes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('propertytype_id') ? old('propertytype_id') : $releaseGood->propertytype->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('setcountry') ? 'is-invalid' : '' }}" name="setcountry_id" id="setcountry_id" required>
                    @foreach($setcountries as $id => $entry)
                        <option value="{{ $id }}" {{ (old('setcountry_id') ? old('setcountry_id') : $releaseGood->setcountry->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city_id" id="city_id" required>
                    @foreach($cities as $id => $entry)
                        <option value="{{ $id }}" {{ (old('city_id') ? old('city_id') : $releaseGood->city->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('city'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('quartier') ? 'is-invalid' : '' }}" name="quartier_id" id="quartier_id" required>
                    @foreach($quartiers as $id => $entry)
                        <option value="{{ $id }}" {{ (old('quartier_id') ? old('quartier_id') : $releaseGood->quartier->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id" id="user_id" required>
                    @foreach($users as $id => $entry)
                        <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $releaseGood->user->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('user'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('liststatut') ? 'is-invalid' : '' }}" name="liststatut_id" id="liststatut_id">
                    @foreach($liststatuts as $id => $entry)
                        <option value="{{ $id }}" {{ (old('liststatut_id') ? old('liststatut_id') : $releaseGood->liststatut->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('emergencylevel') ? 'is-invalid' : '' }}" name="emergencylevel_id" id="emergencylevel_id" required>
                    @foreach($emergencylevels as $id => $entry)
                        <option value="{{ $id }}" {{ (old('emergencylevel_id') ? old('emergencylevel_id') : $releaseGood->emergencylevel->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('libelle') ? 'is-invalid' : '' }}" type="text" name="libelle" id="libelle" value="{{ old('libelle', $releaseGood->libelle) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\ReleaseGood::VERIF_ACCORD_BAILLEUR_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('verif_accord_bailleur') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="verif_accord_bailleur_{{ $key }}" name="verif_accord_bailleur" value="{{ $key }}" {{ old('verif_accord_bailleur', $releaseGood->verif_accord_bailleur) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cout') ? 'is-invalid' : '' }}" type="number" name="cout" id="cout" value="{{ old('cout', $releaseGood->cout) }}" step="1" required>
                @if($errors->has('cout'))
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\ReleaseGood::LOYER_AUGMENTERA_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('loyer_augmentera') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="loyer_augmentera_{{ $key }}" name="loyer_augmentera" value="{{ $key }}" {{ old('loyer_augmentera', $releaseGood->loyer_augmentera) === (string) $key ? 'checked' : '' }} required>
