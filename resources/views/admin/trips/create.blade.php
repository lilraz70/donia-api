    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.trips.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lieu_depart') ? 'is-invalid' : '' }}" type="text" name="lieu_depart" id="lieu_depart" value="{{ old('lieu_depart', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('heure_depart') ? 'is-invalid' : '' }}" type="text" name="heure_depart" id="heure_depart" value="{{ old('heure_depart', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lieu_arrive') ? 'is-invalid' : '' }}" type="text" name="lieu_arrive" id="lieu_arrive" value="{{ old('lieu_arrive', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('heure_arrive') ? 'is-invalid' : '' }}" type="text" name="heure_arrive" id="heure_arrive" value="{{ old('heure_arrive', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cout') ? 'is-invalid' : '' }}" type="text" name="cout" id="cout" value="{{ old('cout', '') }}">
                @if($errors->has('cout'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('typeoftrip') ? 'is-invalid' : '' }}" name="typeoftrip_id" id="typeoftrip_id" required>
                    @foreach($typeoftrips as $id => $entry)
                        <option value="{{ $id }}" {{ old('typeoftrip_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
